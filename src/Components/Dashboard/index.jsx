...
// put this OUTSIDE your component file (top of file, before View)
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        const chart1 = Highcharts.chart("substatus-container", {
          chart: { type: "pie" },
        ...
        const chart2 = Highcharts.chart("timecounts-container", {
          chart: { type: "column" },
